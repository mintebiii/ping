...
export var wallSound = new soundFile("ballwall.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("ballhit.wav");
...
export var adventureMusic = new soundFile("pong music.mp3");
